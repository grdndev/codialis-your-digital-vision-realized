...
const testimonials = [
  ...
  },
  {
    ...
    date: "18 juin 2025",
    content:
      "Jayan s'est montré disponible et a su dépasser mes attentes. Il est de très bon conseil je vous le recommande si vous avez un projet.",
    initials: "S4",
    rating: 5,
  },
  {
