...
const customContentMentions = [
    ...
    '        ',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">1. Informations générales</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">2. Hébergement</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">3. Propriété intellectuelle</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">4. Services proposés</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">5. Limitation de responsabilité</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">6. Liens hypertextes</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">7. Données personnelles</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">8. Cookies</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">9. Droit applicable et juridiction compétente</h2>',
...
const customContentPrivacy = [
    ...
    '        ',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">1. Identité du responsable de traitement</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">2. Données collectées</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">3. Finalités du traitement</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">4. Base légale des traitements</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">5. Destinataires des données</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">6. Durée de conservation</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">7. Cookies</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">8. Vos droits</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">9. Réclamation auprès de la CNIL</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">10. Sécurité des données</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">11. Transferts de données hors Union européenne</h2>',
    ...
    '',
    '        <h2 style="color: var(--white); font-family: ' + String.fromCharCode(39) + 'Orbitron' + String.fromCharCode(39) + ', sans-serif; font-size: 1.2rem; margin-top: 2rem; margin-bottom: 1rem;">12. Modifications de la présente politique</h2>',
